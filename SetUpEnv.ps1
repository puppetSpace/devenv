...
function DownloadFromGithub{
    wget "https://github.com/puppetSpace/terminalthemes/raw/main/Caskaydia%20Cove%20Nerd%20Font%20Complete.ttf" -O $envlocation;
    wget "https://raw.githubusercontent.com/puppetSpace/terminalthemes/main/puppet.omp.json" -O $envlocation;
}

function InstallFont{
    $font = Get-Item -Path "$envlocation/Caskaydia%20Cove%20Nerd%20Font%20Complete.ttf";
